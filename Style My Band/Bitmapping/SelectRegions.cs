...
namespace Bitmapping
{
    public class SelectedRegion : INotifyPropertyChanged
    {
        ...
        public double MinSelectedRegionHeight { get; set; }
        public double MinSelectedRegionWidth { get; set; }
        ...
        public void UpdateCorner(string cornerName, double leftUpdate, double topUpdate)
        {
            UpdateCorner(cornerName, leftUpdate, topUpdate,
                this.MinSelectedRegionWidth, this.MinSelectedRegionHeight);
        }
        ...
        public void UpdateSelectedRect(double scale, double leftUpdate, double topUpdate)
        {
            ...
            double minWidth = Math.Max(this.MinSelectedRegionWidth, width * scale);
            double minHeight = Math.Max(this.MinSelectedRegionHeight, height * scale);
